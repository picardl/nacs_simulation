...
[basis,~,~] = truncate_basis(basis,@(ops) sign(ops.Omega_z),[1,0],1);
...
data = load('../data/deperturbation_230209_181608.mat');
...
options = optimset('Display','iter','PlotFcns',@optimplotfval,'MaxIter',2000);
