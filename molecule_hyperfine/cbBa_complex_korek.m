...
%% basis
basis.UC.qnums = build_basis({'s1','s2','l1','l2'},{1/2,1/2,0,0:1},[1 1 1 1]);
basis.UC.ops = build_operators(basis.UC.qnums);
[basis.SC,basis.UC,basis.change.UC_SC] = couple_angmom(basis.UC,'s1','s2','S');
[basis.SLC,basis.SC,basis.change.SLC_SC] = couple_angmom(basis.SC,'l1','l2','L');
basis_mol.qnums = build_basis({'Lambda','N'},{0:1,0:1},[0,1],'b');
% basis.qnums = build_basis({'J','S','Lambda'},{0:2,0:1,0:1},[0 0 0],'a');
% basis.qnums = build_basis({'J','S','L'},{0:2,0:1,0:1},[0 0 0],'a');
