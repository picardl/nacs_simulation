function out = feshbach_rot(B,save_basis,recompute,const,N_tot)
...
Erange_vs_threshold = [-0.1e6 0.4e6]*const.h/const.hartree;
...
basis = truncate_basis(basis,@(ops) ops.F_z,[3:5]);
