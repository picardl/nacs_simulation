[freqs,survivals,survivals_errs] =  loadFiles('names_20220109_144013');
offs = 310629;
...
r.f_vib = 310629e9; %Freq of transition in Hz. Nearest vibrational level to this value will be selected.
r.pol_up = 'sigpm';
r.pol_frac = 0.5;
...
lsqfitfun =@(b) sum((survivals - HamnRSC(freqs,r,pre,b(1),b(2),b(3),b(4),b(5),guess(6),b(6),b(7))).^2);
...
hold on
plot(ftfreqs,fitfunNoCs([1.0034    0.6256   -0.6877    0.0129],ftfreqs))
% lsqfitfun([1.041932192106372   0.463189933006774  -0.034204393389366  -0.518204057276973   0.091742731242997])
xlabel('Freq [GHz]')
ylabel('Population')
...
%     [beta,R,J,CovB,MSE,ErrorModelInfo] = nlinfit(freqs,survivals,fitfun,[1.0064    0.5671    0.0799   -0.5921    0.0131],opstat,'weights',1./survivals_errs.^2);
    [beta,R,J,CovB,MSE,ErrorModelInfo] = nlinfit(freqs,survivals,fitfunNoCs,[1.0034    0.6256   -0.6077    0.0129],opstat,'weights',1./survivals_errs.^2);
